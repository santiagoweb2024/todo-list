import { ForbiddenException, Injectable } from '@nestjs/common'; // **Importa el decorador Injectable de NestJS para definir el servicio**
...
export class MailService {
  ...
  async sendEmail(to: string, subject: string, html: string) {
    ...
    if (error) {
      ...
      throw new ForbiddenException(error.message); // **Lanza una excepción con el mensaje de error**
    }
